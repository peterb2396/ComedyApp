    ...
    return (
        <div style={{
            ...
            alignItems: "center"
                ...
                <img src = {comic.nearby? "/check.png" : "/x.png"} alt = {comic.nearby? "Yes" : "No"}
                style = {{justifySelf: "center", margin: 0, width: "20px", height: "20px"}}></img>
                <div style = {{display: "flex", justifyContent: "center"}}>
                    <button onClick={() => {alert("hi vito")}} style = {{cursor: "pointer", background: "none", border: "none", padding: "0"}}>
                        <img src = "/not-booked.png" alt="No" style = {{justifySelf: "center", margin: 0, width: "20px", height: "20px"}}></img>
                    </button>
                </div>
